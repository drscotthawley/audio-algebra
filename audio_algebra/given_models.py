# AUTOGENERATED! DO NOT EDIT! File to edit: ../given_models.ipynb.

# %% ../given_models.ipynb 5
...
class DVAEWrapper(GivenModelClass):
    ...
    def __init__(self,
        ...
        **kwargs,
        ...
        self.device = 'cuda' # TBD: should un-hard code this
        self.noise = None 
